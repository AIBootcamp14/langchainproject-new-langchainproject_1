...
| **김수환** | 팀원 | [GitHub 링크](https://github.com/suhwankimkim)         | 에이전트 개발, 데모 streamlit 앱 개발, 디버깅 및 리팩토링|
| **이윤서** | 팀원 | [GitHub 링크](https://github.com/riicoseo)             | RAG 시스템 개발, LangGraph Workflow 구현|
| **이가은** | 팀원 | [GitHub 링크](https://github.com/kkaeunii)             | 에이전트 개발, 프롬프트고도화|
| **이건희** | 팀원 | [GitHub 링크](https://github.com/GH-Lee33)             | 도구 개발, LLM 평가 모듈 구현, 채팅 기록 저장 모듈 구현|
